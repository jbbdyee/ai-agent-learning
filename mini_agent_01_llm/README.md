...
- GPT 이미지 분석과 업로드 검증
- 여행 안내문 MP3 합성 음성 생성
- 카메라 사진과 업로드 영상의 다중 프레임 분석
- 분석 결과를 편집 가능한 안내문과 합성 음성으로 제공
...
`1-7`에서는 카메라 촬영 또는 50MB·2분 이하의 MP4, WebM, MOV 영상을
입력하고, 영상의 대표 프레임 3~10장을 종합 분석한 뒤 결과를 음성으로
생성합니다.
